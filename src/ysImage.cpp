...
namespace ysImageProcessing {
	...
	ysImage::getWidth() const {
		return m_image->sx;
	}

	ysImage::getHeight() const {
		return m_image->sy;
	}

	ysImage::getRed(const int& t_x, const int& t_y) {
	...
	ysImage::getGreen(const int&t_x, const int&t_y) {
	...
	ysImage::getBlue(const int&t_x, const int&t_y) {
	...
	ysImage::getAlpa(const int&t_x, const int&t_y) {
	...
	ysImage::getRGB(const int& t_x, const int& t_y) {
